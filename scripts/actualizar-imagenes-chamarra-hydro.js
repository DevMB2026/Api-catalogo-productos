/**
 * Reemplaza las fotos de "CHAMARRA HYDRO" (Prezenza, slug chamarra-hydro)
 * por las fotos reales del cliente: 2 colores (marino, negro), 4 fotos cada
 * uno (2 caballero + 2 dama). Mismo patrón que los scripts anteriores.
 *
 *   node scripts/actualizar-imagenes-chamarra-hydro.js
 */
...
const SLUG = 'chamarra-hydro';
const IMG_DIR = 'C:/Users/MKT-WEB-DIS/Downloads/CHAMARRA HYDRO-20260827T171213Z-1-001/CHAMARRA HYDRO';

const FOTOS = [
  { archivo: 'Hydro marino 1 caballero.jpg', colorSku: 'AZUL-MARINO', tag: 'marino-caballero-1', sexo: 'hombre' },
  { archivo: 'Hydro marino 3 caballero.jpg', colorSku: 'AZUL-MARINO', tag: 'marino-caballero-2', sexo: 'hombre' },
  { archivo: 'Hydro marino 2 dama.jpg', colorSku: 'AZUL-MARINO', tag: 'marino-dama-1', sexo: 'mujer' },
  { archivo: 'Hydro marino 4 dama.jpg', colorSku: 'AZUL-MARINO', tag: 'marino-dama-2', sexo: 'mujer' },
  { archivo: 'Hydro negro 2 caballero.jpg', colorSku: 'NEGRO', tag: 'negro-caballero-1', sexo: 'hombre' },
  { archivo: 'Hydro negro 4 caballero.jpg', colorSku: 'NEGRO', tag: 'negro-caballero-2', sexo: 'hombre' },
  { archivo: 'Hydro negro 1 dama.jpg', colorSku: 'NEGRO', tag: 'negro-dama-1', sexo: 'mujer' },
  { archivo: 'Hydro negro 3 dama.jpg', colorSku: 'NEGRO', tag: 'negro-dama-2', sexo: 'mujer' }
];
